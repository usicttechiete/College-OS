  ...
  return (
    <section className="space-y-8">
      <header className="space-y-2 text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.4em] text-[var(--color-muted)]">Join the circle</p>
        <h1 className="text-2xl font-semibold text-[var(--color-brand-foreground)]">Create your account</h1>
      ...
      <footer className="text-center text-sm text-[var(--color-muted)]">
        ...
        <Link to="/login" className="font-semibold text-[var(--color-brand-foreground)]">
          Log in
        </Link>
      </footer>
    </section>
